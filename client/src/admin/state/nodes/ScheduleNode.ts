...
export default class ScheduleNode {
    ...
    public getSelectors(): SelectorsInfo<EmployeeAppState & EmployeeAppSelectors, ScheduleSelectors> {
        return {
            ...
            editedClientInfoMiddleNameField: this._store.createField("editedClientInfoMiddleName", "", []),
            editedClientInfoLastNameField: this._store.createField("editedClientInfoLastName", "", []),
...
export type ScheduleState = {
    ...
    editedClientInfoMiddleName: string,
    editedClientInfoLastName: string,
...
export type ScheduleSelectors = {
    ...
    editedClientInfoMiddleNameField: Field,
    editedClientInfoLastNameField: Field,
